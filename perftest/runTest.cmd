...
for /L %%i in (1,1,%ITERATIONS%) do (
    ...
    if "%COMPILER%"=="msvc" (
    start /wait "Build Iteration %%i" cmd /k "call ""C:\Program Files\Microsoft Visual Studio\18\Community\Common7\Tools\VsDevCmd.bat"" && call tools\razzle.cmd && msbuild openconsole.slnx /p:platform=%SILICON%;configuration=%CONFIG% /t:Conhost\Host_EXE /m && echo. && echo Build complete! Press any key to close this window and continue... && pause > nul && exit"
    ) else (
